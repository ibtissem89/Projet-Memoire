...
public class CommandeController {
    ...
    public ResponseEntity<Commande> updateCommandeStatus(@PathVariable Long orderId, @RequestBody String newStatus) {
        Commande savedOrder = orderService.updateCommande(orderId, newStatus);
